...
/**
 * A Ktor client plugin which forwards errors that occur before requests
 * execute with a dummy [HttpResponse].
 *
 * The call attributes will contain a [KEY_INTERNAL_ERROR] containing the
 * exception which can be wrapped and rethrown for consistent handling.
 */
